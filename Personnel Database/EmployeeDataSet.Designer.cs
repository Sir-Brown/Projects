...
namespace Personnal_Database {
    ...
    public partial class EmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(string EmployeeID, string Name, string Position, decimal Hourly_Pay_Rate) {
...
namespace Personnal_Database.EmployeeDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([EmployeeID], [Name], [Position], [Hourly Pay Rate]" +
                ") VALUES (@EmployeeID, @Name, @Position, @Hourly_Pay_Rate);\r\nSELECT EmployeeID, " +
                "Name, Position, [Hourly Pay Rate] FROM Employee WHERE (EmployeeID = @EmployeeID)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [EmployeeID] = @EmployeeID, [Name] = @Name, [Position] = @Position, [Hourly Pay Rate] = @Hourly_Pay_Rate WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name] = @Original_Name) AND ([Position] = @Original_Position) AND ([Hourly Pay Rate] = @Original_Hourly_Pay_Rate));
SELECT EmployeeID, Name, Position, [Hourly Pay Rate] FROM Employee WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Personnal_Database.Properties.Settings.Default.PersonnelConnectionString;
        }
        ...
        public virtual int Delete(string Original_EmployeeID, string Original_Name, string Original_Position, decimal Original_Hourly_Pay_Rate) {
        ...
        public virtual int Insert(string EmployeeID, string Name, string Position, decimal Hourly_Pay_Rate) {
            if ((EmployeeID == null)) {
        ...
        public virtual int Update(string EmployeeID, string Name, string Position, decimal Hourly_Pay_Rate, string Original_EmployeeID, string Original_Name, string Original_Position, decimal Original_Hourly_Pay_Rate) {
            if ((EmployeeID == null)) {
                throw new global::System.ArgumentNullException("EmployeeID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Position, decimal Hourly_Pay_Rate, string Original_EmployeeID, string Original_Name, string Original_Position, decimal Original_Hourly_Pay_Rate) {
            return this.Update(Original_EmployeeID, Name, Position, Hourly_Pay_Rate, Original_EmployeeID, Original_Name, Original_Position, Original_Hourly_Pay_Rate);
        }
    }
